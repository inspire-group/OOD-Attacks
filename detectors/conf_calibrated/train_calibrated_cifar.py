...
parser.add_argument('--test-batch-size', type=int, default=128, help='input batch size for training')
...
train_loader, test_loader,_ = data_utils.load_cifar_dataset(args, args.dataroot)
#data_loader.getTargetDataSet(args.dataset, args.batch_size, args.imageSize, args.dataroot)
...
print('load GAN')
nz = 100
netG = gan_models.Generator(1, nz, 64, 3) # ngpu, nz, ngf, nc
netD = gan_models.Discriminator(1, 3, 64) # ngpu, nc, ndf
